  ...
  if (error) {
    return (
      ...
      >
        ...
        <Text fontSize="2xl" fontWeight="bold" mt={4} color="red.500">Error Loading Bookmarks</Text>
...
if (isLoading) {
  ...
  return (
    <div>
      <Text fontSize="xl" fontWeight="bold" mb={4}>Bookmarks</Text>
    ...
    <div className="grid grid-cols-4 gap-2">
      {data?.data?.length === 0 ? (
        ...
        >
          ...
          <Text fontSize="2xl" fontWeight="bold" mt={4} color="gray.500">No Bookmarks Found</Text>

"use client";
import { Box, Button, Flex, Skeleton, SkeletonCircle, SkeletonText } from "@chakra-ui/react";
...
const Home: React.FC = () => {
  ...
  if(isLoading){
    return <Box className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4 3xl:grid-cols-5">

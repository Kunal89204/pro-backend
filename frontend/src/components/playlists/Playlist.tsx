...
const Playlist = () => {
    ...
    return (
        <div className='flex m-10'>
            <Box>
                <Box w={'30%'} borderRadius={'12px'} position={'relative'}>
                    ...
                    <Image
                        ref={imgRef}
                        src={"http://res.cloudinary.com/dqvqvvwc8/image/upload/v1738686384/kzxbuc9529e8zatxfxn1.jpg"}
                        alt=''
                        width={1000}
                        height={1000}
                ...
                {/* Playlist Details */}
                <Text color={textColor} fontWeight={'semibold'}>Coding</Text>
